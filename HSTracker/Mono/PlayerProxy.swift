...
class PlayerProxy: MonoHandle, MonoClassInitializer {
    ...
    @MonoPrimitiveProperty(property: "ElementalsGiveExtraAttack", owner: PlayerProxy.self)
    var elementalsGiveExtraAttack: Int32

    @MonoPrimitiveProperty(property: "ElementalsGiveExtraHealth", owner: PlayerProxy.self)
    var elementalsGiveExtraHealth: Int32
    ...
    @MonoPrimitiveProperty(property: "DeathrattleCounter", owner: PlayerProxy.self)
    var deathrattleCounter: Int32
    
    @MonoPrimitiveProperty(property: "BeetlesHealthBuff", owner: PlayerProxy.self)
    var beetlesHealthBuff: Int32
    
    @MonoPrimitiveProperty(property: "TavernSpellAtkBuff", owner: PlayerProxy.self)
    var tavernSpellAtkBuff: Int32
    
    @MonoPrimitiveProperty(property: "TavernSpellHealthBuff", owner: PlayerProxy.self)
    var tavernSpellHealthBuff: Int32
    ...
    @MonoPrimitiveProperty(property: "HauntedHealthBuff", owner: PlayerProxy.self)
    var hauntedHealthBuff: Int32
